...
// New ordering follows the real packet life cycle (Acts I-VII).
...
export const LEVELS = {
  ...
  13: level13,  // Act V   - The Request               (HTTP)
  14: level14,  // Act V   - Remember Me               (cookies)
  15: level15,  // Act V   - The Shortcut              (CDN & caching)
  16: level16,  // Act V   - Follow the Redirect       (HTTP redirects)
  17: level17,  // Act VI  - Crossing Borders          (BGP)
  18: level18,  // Act VI  - Nearest Wins              (anycast)
  19: level19,  // Act VI  - The Meeting Point         (IXP)
  20: level20,  // Act VII - The Impersonator          (MITM & HSTS)
  21: level21,  // Act VII - The Flood                 (DDoS & rate limiting)
  22: level22,  // Act VII - Signed Ground             (DNSSEC)
}
